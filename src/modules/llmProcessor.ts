...
const providerMetrics: { [provider: string]: ProviderMetrics } = {};

function initializeProviderMetrics(provider: string) {
...
function updateProviderMetrics(provider: string, success: boolean, responseTime: number, errorType?: string) {
...
export async function getAiUserStories(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are an expert requirements analyst specializing in user story creation. Generate comprehensive user stories following agile best practices and the 'As a [user type], I want [goal] so that [benefit]' format.",
...
export async function getAiUserPersonas(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a UX research expert specializing in user persona development. Create detailed, research-based user personas that represent the target user base.",
...
export async function getAiKeyRolesAndNeeds(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a business process analyst and stakeholder management expert. Identify key user roles and their specific needs, requirements, and business processes.",
            `Based on the comprehensive project context below, identify and describe key roles and their needs:
...
export async function getAiProjectCharter(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager. Create a comprehensive Project Charter following PMBOK 7th Edition standards.",
            `Based on the comprehensive project context below, create a detailed Project Charter with all required PMBOK elements:
...
export async function getAiScopeManagementPlan(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in scope management. Create a comprehensive Scope Management Plan following PMBOK 7th Edition standards.",
            `Based on the comprehensive project context below, create a detailed Scope Management Plan:
...
export async function getAiRiskManagementPlan(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in risk management. Create a comprehensive Risk Management Plan following PMBOK 7th Edition standards.",
...
export async function getAiCostManagementPlan(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in cost management. Create a comprehensive Cost Management Plan following PMBOK 7th Edition standards.",
...
export async function getAiQualityManagementPlan(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in quality management. Create a comprehensive Quality Management Plan following PMBOK 7th Edition standards.",
...
export async function getAiResourceManagementPlan(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in resource management. Create a comprehensive Resource Management Plan following PMBOK 7th Edition standards.",
...
export async function getAiCommunicationManagementPlan(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in communication management. Create a comprehensive Communication Management Plan following PMBOK 7th Edition standards.",
...
export async function getAiProcurementManagementPlan(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in procurement management. Create a comprehensive Procurement Management Plan following PMBOK 7th Edition standards.",
...
export async function getAiWbs(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in work breakdown structures. Create a comprehensive Work Breakdown Structure (WBS) following PMBOK 7th Edition standards.",
            `Based on the comprehensive project context below, create a detailed WBS:
...
export async function getAiWbsDictionary(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in work breakdown structures. Create a comprehensive WBS Dictionary following PMBOK 7th Edition standards.",
...
export async function getAiActivityList(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in schedule management. Create a comprehensive Activity List following PMBOK 7th Edition standards.",
...
export async function getAiActivityDurationEstimates(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in schedule management. Create comprehensive Activity Duration Estimates using three-point estimation and PMBOK 7th Edition standards.",
...
export async function getAiActivityResourceEstimates(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in resource management. Create comprehensive Activity Resource Estimates following PMBOK 7th Edition standards.",
...
export async function getAiScheduleNetworkDiagram(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in schedule management. Create a comprehensive Schedule Network Diagram following PMBOK 7th Edition standards.",
...
export async function getAiMilestoneList(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in schedule management. Create a comprehensive Milestone List following PMBOK 7th Edition standards.",
...
export async function getAiDevelopScheduleInput(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a PMBOK-certified project manager specializing in schedule development. Create comprehensive Schedule Development Input following PMBOK 7th Edition standards.",
            `Based on the comprehensive project context below, create detailed Schedule Development Input:
...
export async function getAiDataModelSuggestions(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a database architect and data modeling expert. Analyze the project context and suggest appropriate data models and database design patterns.",
...
export async function getAiTechStackAnalysis(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a technical architect and technology expert. Analyze the project requirements and provide comprehensive technology stack recommendations.",
            `Based on the comprehensive project context below, provide detailed technology stack analysis:
...
export async function getAiRiskAnalysis(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a risk management expert and project risk analyst. Analyze the project context and identify comprehensive risk factors with mitigation strategies.",
            `Based on the comprehensive project context below, provide detailed risk analysis:
...
export async function getAiAcceptanceCriteria(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a quality assurance expert and business analyst. Create comprehensive acceptance criteria based on user stories and project requirements.",
...
export async function getAiComplianceConsiderations(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a compliance expert and regulatory specialist. Analyze the project context and identify comprehensive compliance requirements and considerations.",
            `Based on the comprehensive project context below, provide detailed compliance analysis:
...
export async function getAiUiUxConsiderations(context: string): Promise<string | null> {
    return await handleAICall(async () => {
        ...
        const messages = createMessages(
            "You are a UX/UI design expert and user experience specialist. Analyze the project context and provide comprehensive user experience and interface design recommendations.",
            `Based on the comprehensive project context below, provide detailed UI/UX considerations:
...
export function getProviderMetrics(provider?: string): { [provider: string]: ProviderMetrics } | ProviderMetrics {
    if (provider) {
        initializeProviderMetrics(provider);
...
export function getProviderPerformanceReport(): string {
...
export function resetProviderMetrics(provider?: string): void {
    if (provider) {
...
export function getContextManagerMetrics(): any {
    return contextManager.getMetrics();
}

export function getContextManagerReport(): string {
    return contextManager.getContextUtilizationReport();
}

export function getBasicContextManagerReport(): string {
...
export function getEnhancedContextManager(): EnhancedContextManager {
 ...
 */
export async function populateEnhancedContextFromAnalysis(analysis: any): Promise<void> {
