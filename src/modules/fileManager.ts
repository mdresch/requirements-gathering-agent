...
// Deprecated: Use async save logic in DocumentGenerator instead for robust outputDir handling
export function saveDocument(documentKey: string, content: string): void {
    throw new Error('saveDocument is deprecated. Use DocumentGenerator.saveDocumentWithFormat for robust async output.');
}

// Removed explicit save logic to enforce async usage
