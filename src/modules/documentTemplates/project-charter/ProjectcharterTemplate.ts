...
All compliance requirements and notifications for this project are addressed in the dedicated compliance documents folder. Please refer to the following compliance templates:
...
These documents contain the mandatory requirements and notifications relevant to this project. The compliance folder must be reviewed annually.

### Annual Compliance Review Checklist
- Verify all compliance templates are up to date
- Confirm all mandatory requirements are addressed
- Review and document any changes in regulations
- Validate implementation of compliance notifications
- Ensure all project documentation references the latest compliance documents
- Record review date and responsible reviewer
