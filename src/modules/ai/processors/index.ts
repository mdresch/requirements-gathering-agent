...
export const getAiMissionVisionAndCoreValues = async (context: string): Promise<string> => await safeProcessorCall(strategicStatementsProcessor.getAiMissionVisionAndCoreValues(context));
export const getAiProjectPurpose = async (context: string): Promise<string> => await safeProcessorCall(strategicStatementsProcessor.getAiProjectPurpose(context));
