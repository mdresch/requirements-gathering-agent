...
function initializeClient() {
    ...
    if (!token) {
        console.warn('REQUIREMENTS_AGENT_TOKEN, AZURE_AI_API_KEY, or GITHUB_TOKEN environment variable not set. LLM functionalities will be skipped.');
    }
    return client;
}
function getModel() {
    return process.env.REQUIREMENTS_AGENT_MODEL || "openai/gpt-4.1";
}
/**
 * Uses AI to generate a project summary and business goals from text content.
...
export async function getAiSummaryAndGoals(textContent) {
    ...
    if (!client) {
        console.log('AI client not initialized. Skipping AI summary.');
        return null;
    }
    ...
    try {
        ...
        if (isUnexpected(response)) {
            console.error('Error calling AI API:', response.body?.error || response.body || 'Unknown error');
...
/**
 * Uses LLM to generate user stories from project context.
...
export async function getAiUserStories(projectContext) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI user stories.');
        return null;
    }
    ...
    try {
        ...
        if (isUnexpected(response)) {
            console.error('Error calling AI API:', response.body.error);
            return null;
        }
        return response.body.choices[0]?.message?.content?.trim() || null;
    }
    catch (error) {
        console.error('Error calling AI API for user stories:', error);
        return null;
    }
}
/**
 * Uses LLM to generate user personas from project context and user stories.
 * @param projectContext - The project summary or description.
...
export async function getAiPersonas(projectContext, userStoriesContent) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI personas.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for personas:', error);
        return null;
    }
}
/**
 * Uses LLM to generate acceptance criteria for user stories.
...
export async function getAiAcceptanceCriteria(userStoriesContent) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI acceptance criteria.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for acceptance criteria:', error);
        return null;
    }
}
/**
 * Uses LLM to generate Vision and Mission statements from project summary and goals.
...
export async function getAiStrategicStatements(projectSummaryAndGoals) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI strategic statements.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for strategic statements:', error);
        return null;
    }
}
/**
 * Uses LLM to generate Core Values and Project Purpose from project summary, goals, vision, and mission.
 * @param projectSummaryAndGoals - The AI-generated project summary and business goals.
...
export async function getAiCoreValuesAndPurpose(projectSummaryAndGoals, visionAndMission) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI core values and purpose.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for core values and purpose:', error);
        return null;
    }
}
/**
 * Uses LLM to generate key user roles and their needs from project context, user stories, and personas.
...
export async function getAiKeyRolesAndNeeds(projectContext, userStories, personas) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI key roles and needs.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for key roles and needs:', error);
        return null;
    }
}
/**
 * Uses LLM to analyze and describe the technology stack from package.json and project summary.
...
export async function getAiTechStackAnalysis(packageJsonData, projectSummary) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI tech stack analysis.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for tech stack analysis:', error);
        return null;
    }
}
/**
 * Uses LLM to suggest a conceptual data model from project context, user stories, and personas.
 * @param projectContext - The AI-generated project summary and business goals.
 * @param userStories - The AI-generated user stories (optional).
 * @param personas - The AI-generated user personas (optional).
...
export async function getAiDataModelSuggestions(projectContext, userStories, personas) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI data model suggestions.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for data model suggestions:', error);
        return null;
    }
}
/**
 * Uses LLM to suggest key process flows from project context, user stories, and key roles/needs.
 * @param projectContext - The AI-generated project summary and business goals.
 * @param userStories - The AI-generated user stories (optional).
...
export async function getAiProcessFlowSuggestions(projectContext, userStories, keyRolesAndNeeds) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI process flow suggestions.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for process flow suggestions:', error);
        return null;
    }
}
/**
 * Uses LLM to perform an initial risk analysis from project context, tech stack, data model, and process flows.
 * @param projectContext - The AI-generated project summary and business goals.
...
export async function getAiRiskAnalysis(projectContext, techStackAnalysis, dataModelSuggestions, processFlows) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI risk analysis.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for risk analysis:', error);
        return null;
    }
}
/**
 * Uses LLM to suggest compliance considerations from project context, data model, personas, and key roles/needs.
 * @param projectContext - The AI-generated project summary and business goals.
 * @param dataModelSuggestions - The AI-generated data model suggestions (optional).
 * @param personas - The AI-generated user personas (optional).
 * @param keyRolesAndNeeds - The AI-generated key roles and needs (optional).
...
export async function getAiComplianceConsiderations(projectContext, dataModelSuggestions, personas, keyRolesAndNeeds) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI compliance considerations.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for compliance considerations:', error);
        return null;
    }
}
/**
 * Uses LLM to suggest UI/UX considerations from project context, user stories, personas, and key roles/needs.
 * @param projectContext - The AI-generated project summary and business goals.
 * @param userStories - The AI-generated user stories (optional).
 * @param personas - The AI-generated user personas (optional).
 * @param keyRolesAndNeeds - The AI-generated key roles and needs (optional).
...
export async function getAiUiUxConsiderations(projectContext, userStories, personas, keyRolesAndNeeds) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI UI/UX considerations.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for UI/UX considerations:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a tailored project kickoff / requirements gathering checklist.
 * @param projectContext - The AI-generated project summary and business goals.
 * @param userStories - The AI-generated user stories (optional).
 * @param keyRolesAndNeeds - The AI-generated key roles and needs (optional).
 * @param techStackAnalysis - The AI-generated tech stack analysis (optional).
...
export async function getAiProjectKickoffChecklist(projectContext, userStories, keyRolesAndNeeds, techStackAnalysis, riskAnalysis) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI project kickoff checklist.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for project kickoff checklist:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Project Charter from a context bundle of project documents.
...
export async function getAiProjectCharter(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Project Charter.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Project Charter:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Stakeholder Register from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiStakeholderRegister(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Stakeholder Register.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Stakeholder Register:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Scope Management Plan from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiScopeManagementPlan(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Scope Management Plan.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Scope Management Plan:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Requirements Management Plan from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiRequirementsManagementPlan(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Requirements Management Plan.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Requirements Management Plan:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Project Scope Statement from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiProjectScopeStatement(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Project Scope Statement.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Project Scope Statement:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Work Breakdown Structure (WBS) from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiWbs(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI WBS generation.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for WBS:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned WBS Dictionary from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiWbsDictionary(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI WBS Dictionary generation.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for WBS Dictionary:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Activity List from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiActivityList(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Activity List generation.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Activity List:', error);
        return null;
    }
}
/**
 * Uses LLM to generate Activity Attributes for each activity in the Activity List, using all relevant project context.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiActivityAttributes(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Activity Attributes generation.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Activity Attributes:', error);
        return null;
    }
}
/**
 * Uses LLM to generate initial Activity Duration Estimates (relative effort, factors, placeholders) for each activity.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiActivityDurationEstimates(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Activity Duration Estimates generation.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Activity Duration Estimates:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a Project Milestone List from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiMilestoneList(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Milestone List generation.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Milestone List:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a Project Schedule Network Diagram description and Mermaid.js syntax from a context bundle.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiScheduleNetworkDiagram(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Schedule Network Diagram generation.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Schedule Network Diagram:', error);
        return null;
    }
}
/**
 * Uses LLM to generate initial Activity Resource Estimates for each activity.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiActivityResourceEstimates(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Activity Resource Estimates generation.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Activity Resource Estimates:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a comprehensive input document for the PMBOK "Develop Schedule" process.
...
export async function getAiDevelopScheduleInput(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Develop Schedule input generation.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Develop Schedule input:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Schedule Management Plan from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiScheduleManagementPlan(contextBundle) {
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Schedule Management Plan:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Cost Management Plan from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiCostManagementPlan(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Cost Management Plan.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Cost Management Plan:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Quality Management Plan from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiQualityManagementPlan(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Quality Management Plan.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Quality Management Plan:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Resource Management Plan from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiResourceManagementPlan(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Resource Management Plan.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Resource Management Plan:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Communications Management Plan from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiCommunicationsManagementPlan(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Communications Management Plan.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Communications Management Plan:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Risk Management Plan from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiRiskManagementPlan(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Risk Management Plan.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Risk Management Plan:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Procurement Management Plan from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiProcurementManagementPlan(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Procurement Management Plan.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Procurement Management Plan:', error);
        return null;
    }
}
/**
 * Uses LLM to generate a PMBOK-aligned Stakeholder Engagement Plan from a context bundle of project documents.
 * @param contextBundle - An object containing relevant project documentation content.
...
export async function getAiStakeholderEngagementPlan(contextBundle) {
    const client = initializeClient();
    if (!client) {
        console.log('LLM client not initialized. Skipping AI Stakeholder Engagement Plan.');
        return null;
    }
    ...
    try {
        ...
        console.error('Error calling AI LLM API for Stakeholder Engagement Plan:', error);
        return null;
    }
}
