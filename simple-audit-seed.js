/**
 * Simple audit trail data seeding script
 * Directly connects to MongoDB and creates sample data
 */
...
async function seedAuditTrailData() {
    ...
    try {
        console.log('🌱 Starting simple audit trail data seeding...');
        ...
        await db.collection('documentaudittrails').deleteMany({});
        await db.collection('compliancemetrics').deleteMany({});
        await db.collection('complianceissues').deleteMany({});
        await db.collection('usersessions').deleteMany({});
        await db.collection('realtimemetrics').deleteMany({});
        ...
        await db.collection('documentaudittrails').insertMany(auditEntries);
        ...
        await db.collection('compliancemetrics').insertMany(complianceMetrics);
        ...
        await db.collection('complianceissues').insertMany(complianceIssues);
        ...
        await db.collection('usersessions').insertMany(userSessions);
        ...
        await db.collection('realtimemetrics').insertMany(realTimeMetrics);
        ...
        // Display summary
        const summary = {
            auditTrailEntries: await db.collection('documentaudittrails').countDocuments(),
            complianceMetrics: await db.collection('compliancemetrics').countDocuments(),
            complianceIssues: await db.collection('complianceissues').countDocuments(),
            userSessions: await db.collection('usersessions').countDocuments(),
            realTimeMetrics: await db.collection('realtimemetrics').countDocuments(),
        ...
        const sampleAuditEntry = await db.collection('documentaudittrails').findOne({});
        console.log('   Sample audit entry:', sampleAuditEntry ? 'Found' : 'Not found');
        
        const sampleComplianceMetric = await db.collection('compliancemetrics').findOne({});
        console.log('   Sample compliance metric:', sampleComplianceMetric ? 'Found' : 'Not found');
